...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        ...
        self.btnNo = Button(self, text="No", width=12,
                            bg="bisque", command=self.btnNo_Click)
        self.btnNo.grid(row=25, column=0)
        self.btnYes = Button(self, text="Yes", width=12,
                             bg="bisque", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1, columnspan=20, sticky="e")

        self.btnClear = Button(self, text="Clear", width=12,
                               bg="bisque", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start", width=12,
                               bg="bisque", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.btnLogin = Button(
            self, text="Login", height="2", width="300", command=self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister = Button(
            self, text="Register", height="2", width="300", command=self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam = Label(self, text="Made by:", bg="slateblue4",
                             width="250", height="1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1 = Label(self, text="CHETAN B R", bg="RoyalBlue1",
                              width="250", height="1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2 = Label(self, text="SOWJANYA H R", bg="RoyalBlue2",
                              width="250", height="1", font=("Calibri", 13))
        self.lblTeam2.pack()
...
class Login(Frame):
    ...
    def createWidget(self):
        ...
        self.btnLogin = Button(self, text="Login", width=10,
                               height=1, command=self.btnLogin_Click)
        self.btnLogin.pack()
...
#        messagebox.showinfo("Failure", self.username1+":"+password1)
        ...
        if username1 in list_of_files:
            ...
            messagebox.showinfo(
                "Failure", "User not found try from another user\n or sign up for new user")
...
class SignUp(Frame):
    ...
    def createWidget(self):
        ...
        self.btnRegister = Button(
            self, text="Register", width=10, height=1, bg="blue", command=self.register_user)
        self.btnRegister.pack()
